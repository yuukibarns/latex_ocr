...
from utils import token2str, post_process, parse_args, seed_everything
import metrics
...
if __name__ == "__main__":
    ...
    if parsed_args.config is None:
        raise ValueError("Path to yaml config file is empty")
    ...
    if parsed_args.checkpoint is None:
        raise ValueError("Path to model checkpoint is empty")
